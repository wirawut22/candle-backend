  ...
  <div> 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">แก้ไขรายการจอง</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">แก้ไขรายการจอง</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <ReserveForm @reserveData="onSubmitted" :reserve="reservePost" :zone="loadZoneData"/>
      </div>
      <!-- /.container-fluid -->
    </section>
    <!-- /.content -->
